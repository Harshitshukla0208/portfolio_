...
const FloatingIcons: React.FC = () => {
    return (
        <div className="z-[10] flex justify-between w-full items-center my-14">
            <a href="mailto:mrharshitshukla2672@gmail.com" className="social">
                <motion.span
            ...
            <a href="https://github.com/Harshitshukla0208" target="_blank" className="social">
                <motion.span
                    animate={{ opacity: 1, scale: 1 }}
                    initial={{ opacity: 0, scale: 0 }}
                    transition={{
            ...
            <a href="https://leetcode.com/u/Harshitshukla_02/" className="social">
                <motion.span
                    animate={{ opacity: 1, scale: 1 }}
                    initial={{ opacity: 0, scale: 0 }}
                    transition={{
