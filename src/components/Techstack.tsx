    ...
    return (
        ...
        >
            <img
                ...
                alt="tech"
                id="react-img"
                className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:top-[260px] 2xl:left-[300px]  1xl:top-[240px] 1xl:left-[300px] 1/2xl:top-[220px] 1/2xl:left-[300px]   xl:top-[260px] xl:left-[300px] lg:top-[200px] lg:left-[290px] md:top-[200px] md:left-[200px] sm:top-[300px] sm:left-[180px] vvs:top-[300px] vvs:left-[120px] top-[300px] left-[120px]  opacity-1 rotate-[0]"
            />
            <img
                src={cpp}
                alt="tech"
                id="cpp-img"
                className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:top-[210px] 2xl:left-[250px] 1xl:top-[190px] 1xl:left-[530px] 1/2xl:top-[170px] 1/2xl:left-[150px] xl:top-[210px] xl:left-[150px] lg:top-[50px] lg:left-[40px] md:top-[150px] md:left-[150px] sm:top-[250px] sm:left-[130px] vvs:top-[250px] vvs:left-[70px] top-[420px] left-[20px] opacity-1 rotate-[0]"
            />
            <img
                src={tailwind}
                alt="tech"
            ...
            <img
                ...
                alt="tech"
                id="nextjs-img"
                className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24  lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:left-[380px] 2xl:bottom-[500px] 1xl:left-[520px] 1xl:bottom-[430px] 1/2xl:left-[280px] 1/2xl:bottom-[450px] xl:left-[280px] xl:bottom-[480px] lg:left-[280px] lg:bottom-[420px] md:left-[240px] md:bottom-[420px] sm:left-[140px] sm:bottom-[420px] vvs:left-[40px] vvs:bottom-[400px] left-[40px] bottom-[670px] opacity-1 rotate-0"
            />
            <img
                src={mongo}
                alt="tech"
                id="mongo-img"
                className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24  lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:right-[380px] 2xl:top-[550px] 1xl:right-[390px] 1xl:top-[580px] 1/2xl:right-[380px] 1/2xl:top-[600px] xl:right-[380px] xl:top-[600px] lg:right-[320px] lg:top-[550px] md:right-[220px] md:top-[600px] sm:right-[250px] sm:top-[600px] vvs:right-[50px] vvs:top-[600px] right-[50px] top-[550px] opacity-1 rotate-[0]"
            />
            <img
                src={typescript}
                alt="tech"
            ...
            <img
                ...
                alt="tech"
                id="css-img"
                className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24  lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute  2xl:top-[140px] 2xl:right-[620px] xl:top-[440px] xl:right-[320px] lg:top-[480px] lg:right-[210px] md:top-[480px] md:right-[210px] sm:top-[400px] sm:right-[140px] vvs:top-[220px] vvs:right-[240px] top-[220px] right-[260px] opacity-1 rotate-[0]"
            />
            <img
                src={mysql}
                alt="tech"
